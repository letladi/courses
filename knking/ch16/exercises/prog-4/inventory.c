 ...
 ***********************************************************************/
 ...
 {
    int i;
    printf("Part number" PART_SPACES "Part Name" NAME_SPACES "Quantity on Hand" PART_SPACES "Price" "\n");
    for (i = 0; i < num_parts; i++) {
      printf(("%11d" PART_SPACES "%c%-26s" "%14d" PART_SPACES "%5f" "\n"),
         inventory[i].number, toupper(inventory[i].name[0]), (inventory[i].name + 1), inventory[i].on_hand, inventory[i].price
      );
   }
}
